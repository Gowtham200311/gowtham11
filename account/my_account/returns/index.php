...
<section id="page-banner" class="page-banner" style="background-image: url('../../../images/bg/page-banner.jpg');"> 
    <div class="container">
      <div class="banner-dtl">
        <h3 class="banner-heading">Returns</h3>      
      </div>
    </div>
  </section>
<!-- end page banner -->
<!--  checkout -->
  <section id="returns" class="account-page register-page">
    <div class="container">
      <div class="row">
        <div class="col-md-3 col-sm-4">
          <div class="customer-profile-main-block">
            ...
            <ul>
                ...
                <li ><a href="http://localhost/e-commerce/account/my_account/history/" title="Order History"><i aria-hidden="true" class="icon_cart_alt"></i>Order History</a></li>
                ...
                <li class="active"><a href="http://localhost/e-commerce/account/my_account/returns/" title="Returns"><i class="fa fa-reply"></i>Returns</a></li>
              </ul>
            </div>
          </div>
        </div>
        <div class="col-md-8 col-md-offset-1 col-sm-8">
          <form id="return-form" action="#" class="register-form return-form">
            <h5 class="register-heading">Not happy with the product? Returns made easy with Origano.</h5>
            <div class="row">
              <div class="col-sm-3">
                <div class="return-text">Order ID *</div>
              </div>
              <div class="col-sm-9">
            ...
            <div class="row">
              <div class="col-sm-3">
                <div class="return-text">Reason *</div>
              </div>
              <div class="col-sm-9">
                <div class="form-group">
                  <input type="text" class="form-control" id="reason" placeholder="Enter Reason Of Return" required="">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-3">
                <div class="return-text">Refund Method *</div>
              </div>
              <div class="col-sm-4 col-xs-6 pad-rt-0">
                <div class="form-group">
                  <input type="radio" name="payment-method" value="Origano Wallet" checked="">
                  <label>Origano Wallet</label>
                </div>
              </div>
              <div class="col-sm-5 col-xs-6">
                <div class="form-group">
                  <input type="radio" name="payment-method" value="Original Payment Method">
                  <label>Original Mode</label>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-3">
                <div class="return-text">Upload Images</div>
              </div>
              <div class="col-sm-9">
                <div class="form-group">
                  <span id="filename">Select Images</span>
                  <label for="file-upload">Browse<input type="file" id="file-upload"></label>
                </div>
              </div>
            </div>
            <button type="submit" class="btn btn-default">Submit Return Request</button>
          </form>
        </div>
      </div>
    </div>
