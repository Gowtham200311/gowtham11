    ...
    <div class="container">
      <div class="row">
        <div class="col-md-3 col-sm-4">
          <div class="customer-profile-main-block">
            ...
            <ul>
                ...
                <li class="active"><a href="http://localhost/e-commerce/account/my_account/address/" title="Address Book"><i aria-hidden="true" class="icon_contacts_alt"></i>Address Book</a></li>
        ...
        <div class="col-md-9 col-sm-8">
          <h3 class="register-page-heading text-center">Manage Addresses</h3>
          ...
          <a href="http://localhost/e-commerce/account/my_account/address/new_address/" class="btn btn-default" title="Add New Address"><i class="fa fa-edit"></i> Add New Address?</a>
        </div>
      </div>
    </div>
  </section>
