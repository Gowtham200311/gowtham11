...
<section id="page-banner" class="page-banner" style="background-image: url('../../../images/bg/page-banner.jpg');"> 
    <div class="container">
      <div class="banner-dtl">
        <h3 class="banner-heading">Origano Wallet</h3>
...
<!-- end page banner -->
<!--  checkout -->
  <section id="wallet" class="account-page register-page wallet-page">
    <div class="container">
      <div class="row">
        <div class="col-md-3 col-sm-4">
          <div class="customer-profile-main-block">
            ...
            <ul>
                ...
                <li class="active"><a href="http://localhost/e-commerce/account/my_account/wallet/" title="Wallet"><i aria-hidden="true" class="icon_wallet"></i>Wallet</a></li>
        ...
        <div class="col-md-7 col-md-offset-1 col-sm-8">
          <h5 class="wallet-text">Your Origano Store Wallet Balance is <span>$75.22</span></h5>
          <form id="wallet-form" action="#" class="register-form wallet-form">
            <div class="register-heading">Topup Your Origano Wallet</div>
            <div class="row">
              <div class="col-sm-8">
                <div class="form-group">
                  <input type="text" class="form-control" id="topup-amount" placeholder="Enter Amount" required="">
                </div>
              </div>
              <div class="col-sm-4">
                <button type="submit" class="btn btn-default"><i class="fa fa-plus-o"></i> Top Up</button>
              </div>
            </div>
            <img src="../../../images/shop/credit-cards.jpg" class="img-responsive" alt="credit-cards">
          </form>
          <div class="why-register-block">
            <h5 class="why-register-heading">Why Use Origano Wallet?</h5>
            <ul>
              <li><i class="fa fa-percent"></i>Receive Exclusive Discount</li>
              <li><i class="fa fa-star-half-o"></i>Get Premium Offers</li>
              <li><i class="fa fa-refresh"></i>Instant Refunds</li>
            </ul>
          </div>
        </div>
      </div>
